...
void file_write(vector<vector<float>> X,vector<int> idx,vector<float> c1,vector<float> c2,vector<rectangle> obs);
...
int main(){
    ...
    //vector<float> R1  = {20,10};
    //vector<float> R2  = {60,100};
    ...
    file_write(X,idx, corner1, corner2, obs);
...
void file_write(vector<vector<float>> X, vector<int> idx,vector<float> c1,vector<float> c2,vector<rectangle> obs)
{
    string points = "RRT_points.txt";
    string environment = "RRT_environment.txt";
